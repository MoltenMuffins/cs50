[Source](https://cs50.harvard.edu/x/2020/psets/1/credit/ "Permalink to Credit - CS50x")
...
Consider the below representative of how your own program should behave when passed a valid credit card number (sans hyphens).
    ...
    $ ./credit Number: 4003600000000014 VISA 
...
But it's up to you to catch inputs that are not credit card numbers (e.g., a phone number), even if numeric:
    ...
    $ ./credit Number: 6176292929 INVALID 
...
## Walkthrough
[![Link to walkthrough video](https://img.youtube.com/vi/dF7wNjsRBjI/0.jpg)](https://youtu.be/dF7wNjsRBjI)
