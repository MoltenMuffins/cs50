[Source](https://cs50.harvard.edu/x/2020/psets/3/tideman/ "Permalink to Tideman - CS50x")
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/2020/psets/3/condorcet_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/2020/psets/3/condorcet_graph_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/2020/psets/3/no_condorcet_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/x/2020/psets/3/lockin.png)
...
Here's how to download this problem's "distribution code" (i.e., starter code) into your own CS50 IDE. Log into [CS50 IDE][1] and then, in a terminal window, execute each of the below.
...
## Walkthrough
[![Link to walkthrough video](https://img.youtube.com/vi/GcJLdVjxo6k/0.jpg)](https://youtu.be/GcJLdVjxo6k)
